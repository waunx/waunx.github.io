...
My research interests encompass reinforcement learning, large language models, and large-scale AI applications, with a particular focus on LLM post-training. I have published several first-author papers at top international AI conferences including ICML, AAAI, and IJCAI, as well as in top journals such as IEEE Transactions on Power Systems with google citations <a href='https://scholar.google.com/citations?user=NhsHZZwAAAAJ'><img src="https://img.shields.io/endpoint?url={{ url | url_encode }}&logo=Google%20Scholar&labelColor=f6f6f6&color=9cf&style=flat&label=citations"></a>
